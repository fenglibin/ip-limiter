package com.eeefff.limiter.core.web.config;
...
import com.eeefff.limiter.core.web.Application;
...
public class IpLimiterWebConfiguration implements WebMvcConfigurer {
	 ...
	 * １、增加IP限流平台包的扫描：<context:component-scan base-package="com.eeefff.limiter"></context:component-scan><br>
