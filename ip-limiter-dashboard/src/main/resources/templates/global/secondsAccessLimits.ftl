...
<body>
	...
	<table width="100%" border="1">
		...
		<tr>
			<td>
				<form action="/global-limiter/resetLimitPretty" method="post">
				  <#if save??>
	...
	<table width="100%" border="1">
		...
		<tr>
			<td align="left">
			<form action="/global-limiter/setIpLimitPretty" method="post">
	...
	<table width="100%" border="1">
		...
		<tr>
			<td align="center" colspan="4"><b>查看及修改（全局）IP及IP段的QPS设置</b></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
			<form action="/global-limiter/delIpLimitPretty" method="post">
			<input type="hidden" name="ip" value="${ipQps.ip!''}" />
