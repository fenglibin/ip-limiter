...
import com.eeefff.limiter.common.action.HttpAction;
...
public class HttpAsyncClientUtil {
	...
	/**
	 * 执行Get请求，响应的内容一定要是com.eeefff.limiter.common.vo.Result格式的。
	 * 
	 * @param url
	 * @return
	 */
	...
	/**
	 * 执行Post请求，响应的内容一定要是com.eeefff.limiter.common.vo.Result格式的。
	 * 
	 * @param data
	 * @param url
